...
.brands0 img{
	...
	height:88px
		...
		<li><a href="allnike1.php">All</a></li>
				<li>|</li>
			<li><a href="productnike1.php" >Basketball</a></li>
			<li>|</li>
			<li><a href="footnike1.php"class="active" style="color:#111;" >Football</a></li>
			<li>|</li>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='football' and brand='nike' ORDER BY product_id DESC") or die (mysqli_error());
