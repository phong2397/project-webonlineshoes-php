...
.brands0 img{
	...
	height:88px
		...
		<li><a href="alldas1.php">All</a></li>
			...
			<li>|</li>
			<li><a href="runningdas1.php" class="active" style="color:#111;">Running</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='running' and brand='adidas' ORDER BY product_id DESC") or die (mysqli_error());
