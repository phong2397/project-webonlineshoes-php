...
<div id="container">
    ...
    <div id="brands0" class="brands-box" style="opacity: 1;">
			...
			<div class="item">
              <a href="#"><img src="img/bitis.jpg" alt="PALLADIUM" class="img-responsive"  width="150px" height="80px"></a>
			</div>
...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="allbitis1.php">All</a></li>
				<li>|</li>
			<li><a href="productbitis1.php" class="active" style="color:#111;">Hang Out</a></li>
			
			<li>|</li>
			<li><a href="runningbitis1.php" >Fitness</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='basketball' and brand='biti' ORDER BY product_id DESC") or die (mysqli_error());
