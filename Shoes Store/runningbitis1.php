...
.brands0 img{
	...
	height:88px
		...
		<li><a href="allbitis1.php">All</a></li>
				<li>|</li>
			<li><a href="productbitis1.php">Hang Out</a></li>
			
			<li>|</li>
			<li><a href="runningbitis1.php" class="active" style="color:#111;">Fitness</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='running' and brand='biti' ORDER BY product_id DESC") or die (mysqli_error());
