...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="alldas.php">All</a></li>
				<li>|</li>
			<li><a href="productdas.php" class="active" style="color:#111;">Basketball</a></li>
			<li>|</li>
			<li><a href="footdas.php" >Football</a></li>
			<li>|</li>
			<li><a href="runningdas.php" >Running</a></li>
		</ul>
	</div>
