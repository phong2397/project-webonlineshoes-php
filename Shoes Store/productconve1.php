...
<div id="container">
	...
	<div class="item">
              <a href="#"><img src="img/conve.png" alt="PALLADIUM" class="img-responsive"  width="150px" height="80px"></a>
			</div>
...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<ul>
		<li><a href="allconve1.php">All</a></li>
				<li>|</li>
			<li><a href="productconve1.php" class="active" style="color:#111;">Limited</a></li>
			
			<li>|</li>
			<li><a href="runningconve1.php" >One Star</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='basketball' and brand='converse' ORDER BY product_id DESC") or die (mysqli_error());
