...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="allnike1.php">All</a></li>
				<li>|</li>
			<li><a href="productnike1.php" class="active" style="color:#111;">Basketball</a></li>
			<li>|</li>
			<li><a href="footnike1.php" >Football</a></li>
			<li>|</li>
			<li><a href="runningnike1.php" >Running</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='basketball' and brand='nike' ORDER BY product_id DESC") or die (mysqli_error());
