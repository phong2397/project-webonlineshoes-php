...
.brands0 img{
	...
	height:88px
		...
		<li><a href="allconve1.php">All</a></li>
				<li>|</li>
			<li><a href="productconve1.php">Limited</a></li>
			
			<li>|</li>
			<li><a href="runningconve1.php" class="active" style="color:#111;">One Star</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='running' and brand='converse' ORDER BY product_id DESC") or die (mysqli_error());
