...
<div id="container">
    ...
    <div id="brands0" class="brands-box" style="opacity: 1;">
		...
		<ul>
		<ul>
		<li><a href="allconve1.php " class="active" style="color:#111;">All</a></li>
				<li>|</li>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE brand='converse' ORDER BY product_id DESC") or die (mysqli_error());
