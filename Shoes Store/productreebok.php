...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="allree.php">All</a></li>
				<li>|</li>
			<li><a href="productreebok.php" class="active" style="color:#111;">Basketball</a></li>
			<li>|</li>
			<li><a href="footballreebok.php" >Work Out</a></li>
			<li>|</li>
			<li><a href="runningreebok.php" >Running</a></li>
		</ul>
	</div>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='basketball' and brand='reebok' ORDER BY product_id DESC") or die (mysqli_error());
