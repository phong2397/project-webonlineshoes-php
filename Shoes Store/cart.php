...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><h4>".formatMoney($price)."</h4></td>";
		...
		echo "<td><strong><h3>Price:$ ".formatMoney($line_cost)."</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>".formatMoney($total)."</h2></strong></td>";
		echo "<td></td>";
