...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="allnike.php">All</a></li>
				<li>|</li>
			<li><a href="productnike.php" class="active" style="color:#111;">Basketball</a></li>
			<li>|</li>
			<li><a href="footnike.php" >Work Out</a></li>
			<li>|</li>
			<li><a href="runningnike.php" >Running</a></li>
		</ul>
	</div>
