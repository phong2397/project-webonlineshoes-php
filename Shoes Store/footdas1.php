...
<div id="container">
    ...
    <div class="item">
              <a href="#"><img src="img/adidas.png" alt="PALLADIUM" class="img-responsive"  width="100px" height="80px"></a>
			</div>
...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="alldas1.php">All</a></li>
				<li>|</li>
			<li><a href="productdas1.php" >Basketball</a></li>
			<li>|</li>
			<li><a href="footdas1.php" class="active" style="color:#111;">Basketball</a></li>
			<li>|</li>
			<li><a href="runningdas1.php" >Running</a></li>
		</ul>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='football' and brand='adidas' ORDER BY product_id DESC") or die (mysqli_error());
