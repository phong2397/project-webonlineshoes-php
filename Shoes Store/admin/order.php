					  ...
					  <table class="table table-hover">
						...
						<th> Action</th>
						  ...
						  <tbody>
							...
							$query1 = $conn->query("SELECT * FROM transaction LEFT JOIN customer ON customer.customerid = transaction.customerid where  transaction_id = '$tid' "  ) or die (mysqli_error());
						$r4 = $query1->fetch_array();
							$customer= $r4['firstname'].' '.$r4['lastname'];
							$anmt=$r4['amount'];
							...
							echo "<td>".formatMoney($anmt)."</td>";
						
							echo "<td><a href='receipt1.php?tdid=".$r1['transaction_id']."'>View</a></td>";
							}
