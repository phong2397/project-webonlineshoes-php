			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<option value="product_size">Select Size</option>
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='update-running.php?id=".$id."' class='btn btn-warning' rel='facebox'><i class='icon-plus-sign icon-white'></i> Update</a> ";
