	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='stockout.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-minus-sign icon-white'></i> Stock Out</a></br>";
					echo "<a href='update-product.php?id=".$id."' class='btn btn-warning' rel='facebox'><i class='icon-plus-sign icon-white'></i> Update</a> ";
