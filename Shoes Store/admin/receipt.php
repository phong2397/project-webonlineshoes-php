...
?>
	...
	<label style="font-size:20px;">Official Receipt</label>
		...
		$amnt = $fetch['amount'];
		echo "<b>Date : </b>". $fetch['order_date'].""."".""."<br>";

		$query1 = $conn->query("SELECT * FROM transaction LEFT JOIN customer ON customer.customerid = transaction.customerid where  transaction_id = '$t_id' "  ) or die (mysqli_error());
