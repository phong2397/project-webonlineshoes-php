...
.brands0 img{
	...
	height:88px
		...
		<li><a href="allree.php">All</a></li>
				<li>|</li>
			<li><a href="productreebok.php">Basketball</a></li>
			<li>|</li>
			<li><a href="footballreebok.php"class="active" style="color:#111;" >Work Out</a></li>
			<li>|</li>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='football' and brand='reebok' ORDER BY product_id DESC") or die (mysqli_error());
