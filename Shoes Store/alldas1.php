...
.brands0 img{
	...
	height:88px
		...
		<ul>
		<li><a href="alldas1.php" class="active" style="color:#111;">All</a></li>
				<li>|</li>
			<li><a href="productdas1.php" >Basketball</a></li>
			<li>|</li>
			<li><a href="footdas1.php" >Basketball</a></li>
			<li>|</li>
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE  brand='adidas' ORDER BY product_id DESC") or die (mysqli_error());
